# Cloudflare Workers搭建ChatGPT、Gemini、通义千问反向代理
...
此方案，如果对接 Gemini 遇到“User location is not supported for the API use”的问题，请按照以下步骤完美解决它：
...
11. 详细的搭建图文说明，请访问以下链接：
    11.1 CSDN 中 guo_zhen_qian 的：[使用Cloudflare创建openai的反向代理](https://blog.csdn.net/guo_zhen_qian/article/details/134957351)
    11.2 GamerNoTitle:[Cloudflare Workers反代实战（下）](https://bili33.top/posts/Cloudflare-Workers-Section2/)
    11.3 Simon's Blog：[simonmy.com](https://simonmy.com/posts/使用netlify反向代理google-palm-api.html)
